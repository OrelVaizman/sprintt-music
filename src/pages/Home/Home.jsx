...
import './Home.scss'
import Playlist from '../../cmps/Playlist/Playlist';
import PlaylistsCarousel from '../../cmps/PlaylistsCarousel/PlaylistsCarousel';

const Home = (props) => {
    return (
        <section className="home container">
            <PlaylistsCarousel title="Featured playlists" playlists={playlists}/>
        </section>
    )
